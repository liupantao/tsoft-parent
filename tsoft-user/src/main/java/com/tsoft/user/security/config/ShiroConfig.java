package com.tsoft.user.security.config;

import java.util.List;
import com.tsoft.user.security.CredentialsMatcher;
import com.tsoft.user.security.filter.MyFormAuthenticationFilter;
import com.tsoft.user.security.filter.SessionControlFilter;
import com.tsoft.user.security.realm.*;
import com.tsoft.user.security.session.SessionManager;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filtersMap.put("myFilter", myFormAuthenticationFilter);
